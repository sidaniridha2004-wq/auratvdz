...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AuraTV is a streaming website that offers live sports channels and match information." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AuraTV — Live Sports & TV Streaming" },
      { name: "description", content: "AuraTV is a streaming website that offers live sports channels and match information." },
      { name: "twitter:description", content: "AuraTV is a streaming website that offers live sports channels and match information." },
